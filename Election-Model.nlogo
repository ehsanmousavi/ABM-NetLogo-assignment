turtles-own [Voting-Status Strategy Perceived-Turnout Vote P]

to setup
  ca

  ;; sum of the agents who will definitely vote and not vote
  let Total-Vote-and-NotVote Percentage-of-Agents-definitely-Vote + Percentage-of-Agents-definitely-Not-Vote

  ;; check if the sum of the agents who will definitely vote and not vote is less than 100%
  if ( Total-Vote-and-NotVote > 100 ) [ user-message ("The sum of the agents who will definitely vote and not vote must be less than 100%." ) ]

  ;; calculate the number of the agents who will vote, will not vote, and undecided agents
  let Def-Vote-Number Total-Number-of-Agents * Percentage-of-Agents-definitely-Vote / 100
  set Def-Vote-Number int Def-Vote-Number
  let Def-Not-Vote-Number Total-Number-of-Agents * Percentage-of-Agents-definitely-Not-Vote / 100
  set Def-Not-Vote-Number int Def-Not-Vote-Number
  let Undecided-Agents-Number Total-Number-of-Agents - Def-Vote-Number - Def-Not-Vote-Number
  let Undecided-Agents-Strategy-1-Number Undecided-Agents-Number * Percentage-of-Undecided-Choose-Strategy-1 / 100
  set Undecided-Agents-Strategy-1-Number int Undecided-Agents-Strategy-1-Number
  let Undecided-Agents-Strategy-0-Number Undecided-Agents-Number - Undecided-Agents-Strategy-1-Number

  ;; creating initial agents
  ;; creating agents who will vote
  crt Def-Vote-Number [
    setxy random-xcor random-ycor
    set color green
    set shape "person"
    set Voting-Status "Vote"
    set Strategy 3 ;; strategy number 3 is voting all the time
    set Vote 1
  ]
  ;; creating agents who will not vote
  crt Def-Not-Vote-Number [
    setxy random-xcor random-ycor
    set color red
    set shape "person"
    set Voting-Status "Not-Vote"
    set Strategy 4 ;; strategy number 4 is never voting
    set Vote 0
  ]
  ;; creating agents who are undecided
  ;; Undecided with strategy 0
  crt Undecided-Agents-Strategy-0-Number [
    setxy random-xcor random-ycor
    set color white
    set shape "person"
    set Voting-Status "Undecided"
    set Strategy 0
    set Vote random(2)
  ]
  crt Undecided-Agents-Strategy-1-Number [
    setxy random-xcor random-ycor
    set color white
    set shape "person"
    set Voting-Status "Undecided"
...
to go
  let Total-Turnout-Number count turtles with [Vote = 1]
  let Total-Turnout-Percentage Total-Turnout-Number * 100 / Total-Number-of-Agents
  let Total-No-Vote-Number Total-Number-of-Agents - Total-Turnout-Number

  ask turtles [
    if ( Voting-Status = "Undecided" ) [ ;; check if the agent is undecided
      if ( Strategy = 0 ) [ ;; agents with strategy 0
        set Perceived-Turnout Total-Turnout-Percentage
        ifelse ( Perceived-Turnout < Desired-Turnout-Percentage-for-Undecided-Voters ) [
          set Vote 1
        ]
        [
          set Vote 0
      ...
      if ( Strategy = 1 ) [ ;; agents with strategy 1
        ifelse ( Total-Turnout-Percentage < Desired-Turnout-Percentage-for-Undecided-Voters ) [
          ifelse ( Desired-Turnout-Percentage-for-Undecided-Voters - Total-Turnout-Percentage > 20 ) [
            set Perceived-Turnout Total-Turnout-Percentage + (Total-No-Vote-Number * 60 / 100)
          ]
          [
            set Perceived-Turnout Total-Turnout-Percentage + (Total-No-Vote-Number * 5 / 100)
          ]
        ]
        [
          ifelse ( Total-Turnout-Percentage - Desired-Turnout-Percentage-for-Undecided-Voters > 20 ) [
            set Perceived-Turnout Total-Turnout-Percentage - ((Total-Turnout-Percentage - Desired-Turnout-Percentage-for-Undecided-Voters) * 1.3)
          ]
          [
            set Perceived-Turnout Total-Turnout-Percentage
          ]
...
289
110
Percentage-of-Agents-definitely-Vote
Percentage-of-Agents-definitely-Vote
0
100
10.0
...
613
111
Percentage-of-Agents-definitely-Not-Vote
Percentage-of-Agents-definitely-Not-Vote
0
100
5.0
...
618
164
Desired-Turnout-Percentage-for-Undecided-Voters
Desired-Turnout-Percentage-for-Undecided-Voters
1
100
65.0
...
"" ""
PENS
"Turnout Percentage" 1.0 0 -13345367 true "" "plot ((count turtles with [vote = 1]) * 100 / Total-Number-of-Agents)"
...
278
292
Undecided agents with strategy 0
count turtles with [Strategy = 0]
17
1
11
...
277
341
Undecided agents with strategy 1
count turtles with [Strategy = 1]
17
1
11
...
607
339
Number of undecided agents (Strategy 0) who vote
count turtles with [Vote = 1 and Strategy = 0]
17
1
11
...
608
287
Number of undecided agents (Strategy 1) who vote
count turtles with [Vote = 1 and Strategy = 1]
17
1
11
...
291
165
Percentage-of-Undecided-Choose-Strategy-1
Percentage-of-Undecided-Choose-Strategy-1
0
100
22.0
